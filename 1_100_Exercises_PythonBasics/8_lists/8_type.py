...
# using built-in function "isinstance", it checks where the first argument reference an instance of the type given by the second argument. e.g. isinstance = (some_value1, list) # True 